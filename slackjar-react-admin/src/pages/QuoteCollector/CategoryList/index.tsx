...
import { Table, Button, Modal, Form, Input, message, Space, Popconfirm, Tag, Card, Row, Col, Statistic, Empty, InputNumber } from 'antd';
    ...
    },
    {
      ...
      render: (_: unknown, record: QuoteCategory) => (
        <Space>
          ...
          <Popconfirm title="确定删除这个分类吗？" onConfirm={() => handleDelete(record.id)} okText="确定" cancelText="取消">
