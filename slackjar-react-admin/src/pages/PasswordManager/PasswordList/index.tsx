...
import {
    ...
    type PasswordEntryCreateRequest,
    type PasswordEntryUpdateRequest,
    type PasswordCategory
} from '../../../apis/modules/passwordmanager';
...
const PasswordList: React.FC = () => {
    ...
    const handleEdit = (record: PasswordEntryDTO) => {
    ...
    const handleModalOk = async () => {
        try {
            ...
            const data: PasswordEntryCreateRequest | PasswordEntryUpdateRequest = {
            ...
            if (editingItem) {
                ...
                await createPassword(data as PasswordEntryCreateRequest);
    ...
    const columns = [
            ...
            render: (text: string, record: PasswordEntryDTO) => (
                <Space>
                    <span className="font-mono text-sm">
                        {visiblePasswords.has(record.id) ? text : '******'}
                    </span>
                    <Button
                        icon={visiblePasswords.has(record.id) ? <EyeOutlined /> : <EyeOutlined />}
                        size="small"
        ...
        },
        {
            ...
            render: (text: number) => getStrengthTag(text)
        },
        {
            title: '最后登录',
        ...
        <div className="p-6">
            <Card className="mb-6">
                <Row gutter={16}>
                    ...
                    <Col span={8}>
                        <Statistic
                            title="社交分类"
                            value={statistics['social'] || 0}
                            prefix={<Badge color="#faad14" />}
                        />
                    </Col>
                </Row>
            </Card>
                    ...
                    <Row align="middle" gutter={16}>
                        ...
                        <Col span={10}>
                            <Space>
                                ...
                                <Button
                                    icon={<ReloadOutlined />}
                                    onClick={() => fetchPasswordList(selectedCategory || undefined)}
                                >
                                    刷新
                                </Button>
                                <Button
            ...
            <Card title="密码列表">
                <Table
                    ...
                    bordered
                    locale={{ emptyText: <Empty description="暂无密码记录" /> }}
                />
            </Card>
            ...
            >
                <Form form={generateForm} layout="vertical">
                    ...
                    <Space className="float-right">
                        ...
                        <Button onClick={handleGeneratePassword} icon={<ReloadOutlined />}>
                            重新生成
                        </Button>
                        <Button type="primary" onClick={handleUseGeneratedPassword}>
                            使用此密码
                        </Button>
                    </Space>
                </Form>
